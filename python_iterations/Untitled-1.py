#So, I completed this assignment the first time around uising a "stupid" method that didn't use dictionaries. Once I realized that I could use disctionaries,
#I went back a redid the script to utilize dictionaries instead. I've included the my old script because I am happy that I managed to do it my way first, but 
#I also wanted to provide the "right" way to do it based off our previous exercises.
import os
import csv
